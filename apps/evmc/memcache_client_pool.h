...
class MemcacheClientPool : MemcacheClientBase {
 public:
  ...
  // @brief
  // @param[in] vbucket_conf - �����ָ�ʽ
  //      1. memcached��ʵ��ģʽ������Ĳ���Ӧ�� "host:port"
  //      2. memcached��Ⱥģʽ������Ĳ���������vbucket conf url �� "http://host:port/vbucket_conf"
  //      3. memcached��Ⱥģʽ������Ĳ���������vbucket conf �����ļ��� "/the/path/to/vbucket_conf"
  // @param[in] thread_num -
  // @param[in] timeout_ms -
  // @return  -
